...
function Ze(e) {
  ...
  let a = false, r = false, l = -1, c = -1, m = 0, p, S = [];
  {
    let z = -1;
    for (const f of s)
...
function j(e, t, n) {
  ...
  F = new Map(F), F.set(e, t), it.emit("groupChange", {
    group: e,
    isUserInteraction: (n == null ? void 0 : n.isUserInteraction) === true,
    prev: o,
    next: t
  });
}
...
function at({
  ...
  const n = () => {
    ...
    if (f && r < p && (z || l.slice(0, S).every((h, y) => {
      const b = m[y];
      return (b == null ? void 0 : b.collapsible) && k(b.collapsedSize, c[b.panelId]);
    }))) {
...
function $e(e) {
  ...
  if (!n.disabled)
    switch (e.key) {
      ...
      case "Enter": {
        e.preventDefault();
        const o = pe(t), i = H(o.id, true), { derivedPanelConstraints: s, layout: u, separatorToPanels: a } = i, r = o.separators.find(
          (p) => p.element === t
        );
...
function Xt({
  ...
  const z = (0, import_react.useRef)({
    ...
    W(z.current.onLayoutChange, x) || (z.current.onLayoutChange = x, r == null ? void 0 : r(x));
  }), d = se(
    (x, P) => {
      W(z.current.onLayoutChanged, x) || (z.current.onLayoutChanged = x, l == null ? void 0 : l(x, { isUserInteraction: P }));
    }
  ...
  return q(() => {
    ...
    N.current = R;
    const E = Bt(R), { defaultLayoutDeferred: D, derivedPanelConstraints: V, layout: ue } = H(R.id, true);
  ...
  }), (0, import_jsx_runtime.jsx)(ct.Provider, { value: G, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...S,
      className: t,
...
function sn({
  ...
  const s = n !== void 0, u = "id" in i ? i.id : i.groupId, a = he(u, n ?? []), r = (0, import_react.useSyncExternalStore)(
    Yt,
    () => o.getItem(a),
    () => o.getItem(a)
  ...
  }, [l, u, n, o]), m = l ?? c, p = (0, import_react.useRef)(null), S = (0, import_react.useCallback)(() => {
    const d = p.current;
  ...
  const z = (0, import_react.useCallback)(
    ...
    (d) => {
      S(), e === 0 ? z(d, { isUserInteraction: false }) : p.current = setTimeout(() => {
        z(d, { isUserInteraction: false });
      }, e);
    },
    [S, e, z]
  );
...
function Zt({
  ...
  const f = !!r, d = Le(r), h = Re({
    disabled: s
  }), y = (0, import_react.useRef)(null), b = Ce(y, u), {
    getPanelStyles: v,
    id: g,
    orientation: w,
    registerPanel: M,
  ...
  }, P = (0, import_react.useSyncExternalStore)(
    (R) => Pe(g, R),
    x,
    x
  );
  ...
  return P ? I = JSON.parse(P) : i !== void 0 ? I = {
    ...
    flexShrink: void 0,
    flexBasis: i
  } : I = { flexGrow: 1 }, (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...z,
...
function tn({
  ...
  const r = Le(s), l = Re({
    disabled: n,
    disableDoubleClick: o
  }), [c, m] = (0, import_react.useState)({}), [p, S] = (0, import_react.useState)("inactive"), [z, f] = (0, import_react.useState)(false), d = (0, import_react.useRef)(null), h = Ce(d, i), {
    disableCursor: y,
    id: b,
    orientation: v,
    registerSeparator: g,
  ...
  }, [b, r, g, l]), (0, import_react.useEffect)(() => {
